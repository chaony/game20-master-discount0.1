local M = class("TinShotControl", LikeOO.OOControlBase)
...
function M:onHandle(msg, data)
    ...
    elseif msg == "reward_show_btn" then --奖励预览
        self:openView("Activities.TinShot.TinShotRewardPreview",{version = self.m_model.version})
    ...
    elseif msg == "change_btn" then --商城
        local shop_name = {}
        shop_name["28"] = "tid#SpringFestival_canname"
        self:openView("Shop", {shop_type = 28, shop_name = shop_name})
    ...
    elseif msg == "help_btn" then
        ...
        local content = "tid#SpringFestival_can"
        local open_data = self.m_model:getActiveCfgByOpenId(265)
        local titleName = "tinshot_text001"--open_data.name
