...
---@field m_model DeliciousFeastExchangeModel
local M = class("DeliciousFeastExchangeView",LikeOO.OOPopBase)

M.m_uiName = "Activities/DeliciousFeast/DeliciousFeastExchange"
M.m_size_type = 1
M.m_iphoneXAdapter = true

function M:onEnter()
    self:setTextByLanKey("close_title_text", "feast_text_0004")
