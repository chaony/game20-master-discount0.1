...
local M = class("DeliciousFeastGiftBagModel", LikeOO.OODataBase)

function M:onCreate()
    M.super.onCreate(self)
    self.m_open_id = self.m_params.openId or 324
...
function M:getSpineName()
    if self.m_params.spineName == nil then
        self.m_params.spineName = { meituan = "MeiTuan_SkeletonData", xian = "hero_8101_SkeletonData" }
    end
