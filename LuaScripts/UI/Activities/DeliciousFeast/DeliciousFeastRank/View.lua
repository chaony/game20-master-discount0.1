...
local M = class("DeliciousFeastRankView", LikeOO.OOPopBase)

M.m_uiName = "Activities/DeliciousFeast/DeliciousFeastRank"
M.m_size_type = 1
...
function M:refreshOthersNode()
    local isShowRank = self.m_model:getRankCount() > 2
...
function M:bindUI()
    self:setTextByLanKey("close_title_text", "feast_text_0005")
