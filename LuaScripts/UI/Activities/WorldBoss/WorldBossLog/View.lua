local M = class("WorldBossLogView",LikeOO.OOPopBase)

M.m_uiName = "Activities/WorldBoss/WorldBossLog"
M.m_size_type = 2
...
function M:updateScrollViewCell(index, cell_object, cell_data)
	...
	score_text.text = string.format(Language:getTextByKey("world_boss_str_0010"), cell_data.damage or 0)
end
return M