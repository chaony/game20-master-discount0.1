local M = class("KingsoftHistoryNode",LikeOO.OOUIbase)

M.m_uiName = "Activities/Kingsoft/KingsoftHistoryNode"
...
function M:onEnter()
    ...
    self:setTextByLanKey("history_text", "kingsoft_text_0047")
...
function M:updateResultListScroll()
    local data = self.m_model:getHistoryData()
...
function M:updateResultCell(index, cell_object, cell_data)
    ...
    LuaBehaviourUtil.setText(luaBehaviour, "value_text3", tostring(real_num))
