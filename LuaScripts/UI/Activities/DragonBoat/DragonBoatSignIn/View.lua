local M = class("DragonBoatSignInView",LikeOO.OOPopBase)

M.m_uiName = "Activities/DragonBoat/DragonBoatSignIn"
M.m_size_type = 2
...
function M:setSpine()
    ...
    self.cacheSpineName = "hero_0101_yongzhuang_SkeletonData"
