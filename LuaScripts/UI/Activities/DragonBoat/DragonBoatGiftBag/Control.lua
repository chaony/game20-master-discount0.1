---@class DeliciousFeastGiftBagControl: OOControlBase
---@field m_model DragonBoatGiftBagModel
---@field m_view DragonBoatGiftBagView
local M = class("DragonBoatGiftBagControl",LikeOO.OOControlBase)
...
function M:onHandle(msg , data)
    ...
    elseif msg == "explain_btn" then
        -- 说明
        self:openView("Pops.CommonHelpPop", { title = self.m_model.active_name, content = Language:getTextByKey("tid#MTDes1") })
    elseif msg == "refresh_data" then
        ...
        local param = {}
        param.open_id = self.m_model.m_open_id
        param.vsn = self.m_model.m_version
