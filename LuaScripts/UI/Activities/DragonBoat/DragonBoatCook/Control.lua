...
local M = class("DragonBoatCookControl", LikeOO.OOControlBase)
...
function M:onHandle(msg, data)
    ...
    elseif msg == "explain_btn" then
        -- 说明
        self:openView("Pops.CommonHelpPop", { title = Language:getTextByKey("tid#OpenConditionName_352"), content = Language:getTextByKey("tid#MTDes1") })
    end
end
