local M = class("LuckyRabbitHutTimesPopView",LikeOO.OOPopBase)
...
function M:onEnter()
	...
	self:setObjectVisible("money_num_txt" , self.m_model.m_cost)
	self:setObjectVisible("money_icon" , self.m_model.m_cost)
...
function M:refreshUI()
	--购买数量
	self:setTextByLanKey("bug_num_txt", self.m_model.m_cur_num);
	--购买花费
