local M = class("HuntTreasuresAreaInfoPop", LikeOO.OODataBase)

function M:onCreate()
	M.super.onCreate(self)
	self.m_transfer = "scale"
	self.m_mine_oid =  self.m_params.mines_data.oid
	self:getData("mining_mine_detail",{mine_oid = self.m_mine_oid})
end
...
function M:getRegionName()
	local name = self.m_mining_region_config[self.m_region_id]["name"]
	return name
end
