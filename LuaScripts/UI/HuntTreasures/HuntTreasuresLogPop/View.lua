local M = class("HuntTreasuresLogPopView",LikeOO.OOPopBase)

M.m_uiName = "HuntTreasures/HuntTreasuresLogPop"
M.m_size_type = 2
...
function M:onEnter()
    ...
    UserDataManager:removeRedDotByKey("mining_blog")
end
...
function M:updateItemInfo(obj, data, id)
    ...
    LuaBehaviourUtil.setTextByLanKey(luaBehaviour, "go_text", "hunt_treasure_str_063")
    local is_win = 0
    ...
    LuaBehaviourUtil.setObjectVisible(luaBehaviour, "lost_text", false)
end
