local M = class("JuBaoShanGiftBagBagView",LikeOO.OOPopBase)

M.m_uiName = "Activities/Voyage/VoyageGiftBag"
M.m_size_type = 2
...
function M:updateScrollViewCell(index, cell_object, cell_data)
	...
	if refresh == 0 then -- 无限制
		...
		if refresh == 1 then
			LuaBehaviourUtil.setTextByLanKey(luaBehaviour,"limit_times_text", "new_str_0795", time_limit - cell_data.buy_times)
		else
