...
local M = class("SettlementMythArenaLostNode",LikeOO.OOUIbase)

M.m_uiName = "Settlement/SettlementMythArenaLostNode"
...
function M:refreshUI()
	...
	self:setObjectVisible("arrow_img", pre_rank > 0)
	self:setObjectVisible("right_rank_text", pre_rank > 0)
	self:setObjectVisible("left_rank_text", pre_rank > 0)
	self:setObjectVisible("rank_title_text", pre_rank > 0)
...
function M:updateScrollViewCell(index, cell_object, cell_data)
	...
	LuaBehaviourUtil.setTextByLanKey(luaBehaviour, "left_player_team_num_text", "peak_str_0036", index)
	LuaBehaviourUtil.setTextByLanKey(luaBehaviour, "right_player_team_num_text", "peak_str_0036", index)
