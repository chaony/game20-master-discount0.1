---@class SettlementMultChapterWinNode:OOUIbase
---@field m_model SettlementModel
--- 章节结算 成功
local M = class("SettlementMultChapterWinNode",LikeOO.OOUIbase)

M.m_uiName = "Settlement/SettlementMultChapterWinNode"
...
function M:showRelicChoice()
    if self.m_model.m_mode==GlobalConfig.BATTLE_MODE.XIAKEDAO_MULTI then
        --self.m_model.m_data.drop_heirlooms={}
        --self.m_model.m_data.drop_heirlooms[1]={
        --    [1]=46,
        --    [2]=44
        --}
