---@class ForbiddenHeroView:OOPopBase
---@field m_model ForbiddenHeroModel
local M = class("ForbiddenHeroView",LikeOO.OOPopBase)
...
function M:onEnter()
	...
	self:setTextByLanKey("left_tips", "arena_str_0037")
