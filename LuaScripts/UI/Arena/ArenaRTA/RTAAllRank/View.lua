...
---
---@class RTAAllRankView:OOPopBase
---@field m_model RTAAllRankModel
local M = class("RTAAllRankView",LikeOO.OOPopBase)

M.m_uiName = "Arena/ArenaRTA/RTAAllRank"  -- prefab name
M.m_size_type = 1
    ...
    for index = 1, 3 do
        ...
        if isExistRole then
            ...
            if luaBehaviour then
                ...
                LuaBehaviourUtil.setTextByLanKey(luaBehaviour, "text_score", itemData.score)
                --加载spine动画
