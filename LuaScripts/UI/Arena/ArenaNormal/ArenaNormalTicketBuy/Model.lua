local M = class("ArenaNormalTicketBuyModel", LikeOO.OODataBase)
...
function M:onEnter()
	...
	self.m_num = 1
	self.m_max_num =  ConfigManager:getCommonValueById(454,99)
...
function M:getCost()
    ...
    local system_cost_item = system_cost[5] or {}
...
function M:getBuyItem()
    ...
    return {RewardUtil.REWARD_TYPE_KEYS.ITEM, 1004, 0}
end
