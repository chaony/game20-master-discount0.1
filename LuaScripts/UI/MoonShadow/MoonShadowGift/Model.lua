local M = class("MoonShadowGiftModel", LikeOO.OODataBase)
...
function M:updateGiftData(callback)
	...
	self:getNetData("mood_shadow_index", nil, netCallback)
end

function M:updateShowData()
	self.m_show_data = {}
	local moon_shadow_gift_tab = ConfigManager:getCfgByName("mood_shadow_gift")[self.m_version] or {}
