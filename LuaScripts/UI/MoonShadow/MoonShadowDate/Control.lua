local M = class("MoonShadowDateControl",LikeOO.OOControlBase)
...
function M:onHandle(msg , data)
    if msg == 99999 then    -- 返回
        self:updateMsg("refreshRedPointDate", nil, "MoonShadow.MoonShadowMain")
        self:closeView()
...
function M:questRewardTaskDetail(data)
    ...
    self.m_model:getNetData("mood_shadow_receive_quest", params, netCallback)
end
...
function M:questRewardBox(data)
    ...
    self.m_model:getNetData("mood_shadow_recv_score_reward", params, netCallback)
end
