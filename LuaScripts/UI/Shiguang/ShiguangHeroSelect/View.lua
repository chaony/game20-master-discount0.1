local M = class("ShiguangHeroSelectView",LikeOO.OOPopBase)

M.m_uiName = "Shiguang/ShiguangHeroSelect"
M.m_size_type = 2

function M:onEnter()
	self:setTextByLanKey("tips_text", "new_str_0165")
	self:setTextByLanKey("common_title_text", "new_str_0164")
	...
	if self.m_loop_scroll_view == nil then
		...
		local params = {
			...
			update_cell = function(index, cell_object, cell_data)
				...
				duigou_img:SetActive(self.m_model.m_select_index == index)
