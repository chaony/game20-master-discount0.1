local M = class("WdTowerRankView",LikeOO.OOPopBase)

M.m_uiName = "WdTower/WdTowerRank"
M.m_size_type = 2
...
function M:updateItemInfo(obj, data, id)
    ...
    if id then
		...
		active_combat = self.m_model.m_data.combat or 0
