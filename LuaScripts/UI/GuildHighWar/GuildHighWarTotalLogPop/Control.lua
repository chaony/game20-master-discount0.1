local M = class("GuildHighWarTotalLogPopControl",LikeOO.OOControlBase)
...
function M:onHandle(msg , data)
    ...
    elseif msg == "statistics_btn" then
        if data and data.cell_data and data.cell_data.battle_log_id then
            self:openView("Pops.BattleStatistics", {battle_id = data.cell_data.battle_log_id, mode = GlobalConfig.BATTLE_MODE.GUILD_HIGH_WAR})
        end
