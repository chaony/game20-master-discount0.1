...
M.m_uiName = "GuildHighWar/GuildHighWarMachineMain"
M.m_size_type = 2
M.m_iphoneXAdapter = true

function M:onEnter()
	--self.m_attr_node = GameUtil:commonAttrNode(self.m_control, {mode = 18})
	self:setTextByLanKey("close_title_text", "guild_high_war_new_0055")
	local cfg = ConfigManager:getCfgByName("talent_page")
	self:setTextByLanKey("machine_title1",cfg[1].name or "guild_high_war_yan_text_001")
	self:setTextByLanKey("machine_title2", cfg[2].name or "guild_high_war_yan_text_001")
	self:setTextByLanKey("machine_title3", cfg[3].name or "guild_high_war_yan_text_001")
	self:setTextByLanKey("machine_name1", "guild_high_war_yan_text_004")
	self:setTextByLanKey("machine_name2", "guild_high_war_yan_text_005")
	self:setTextByLanKey("machine_name3", "guild_high_war_yan_text_005")
	self:setTextByLanKey("machine_content1", "guild_high_war_yan_text_0010")
	self:setTextByLanKey("machine_content11", "guild_high_war_yan_text_0011")
	self:setTextByLanKey("machine_content2", "guild_high_war_yan_text_0012")
	self:setTextByLanKey("machine_content22", "guild_high_war_yan_text_0013")
	self:setTextByLanKey("machine_content3", "guild_high_war_yan_text_0014")
	self:setTextByLanKey("machine_content33", "guild_high_war_yan_text_0024")
	self:refreshUI()
end
