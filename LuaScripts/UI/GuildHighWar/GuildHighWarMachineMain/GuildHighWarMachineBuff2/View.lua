...
M.m_uiName = "GuildHighWar/GuildHighWarMachineMain/GuildHighWarMachineBuff2"
M.m_size_type = 2
M.m_iphoneXAdapter = true

function M:onEnter()
	self.m_attr_node = GameUtil:commonAttrNode(self.m_control, {mode = 49})
...
local ImgPath = {
	[1] = {di = "a_dfbhz_zwss_jn_dilan",empty = "a_dfbhz_zwss_jn_jianhui",icon = "a_dfbhz_zwss_jn_jianlan"},
	[2] = {di = "a_dfbhz_zwss_jn_dilan",empty = "a_dfbhz_zwss_jn_dunhui",icon = "a_dfbhz_zwss_jn_dunlan"},
	[3] = {di = "a_dfbhz_zwss_jn_dilan",empty = "a_dfbhz_zwss_jn_xinhui",icon = "a_dfbhz_zwss_jn_xinlan"},
	[4] = {di = "a_dfbhz_zwss_jn_dilan",empty = "a_dfbhz_zwss_jn_shuhui",icon = "a_dfbhz_zwss_jn_shulan"},
}
