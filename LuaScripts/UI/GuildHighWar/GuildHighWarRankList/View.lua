...
M.m_uiName = "GuildHighWar/GuildHighWarRankList"
M.m_size_type = 2
...
function M:switchNode(index)
	...
	if index == 1 then
		self:setTextByLanKey("player_label_text", "new_str_0476")
		...
		--
		self:setObjectVisible("score_label_text",false)
		self:setObjectVisible("power_label_text",false)
		self:setObjectVisible("gang_label_text",false)
		self:setObjectVisible("player_label_text",false)
		self:setObjectVisible("gang_label_text2",true)
		self:setObjectVisible("gang_label_text3",false)
		self:setObjectVisible("hint_btn",false)
		self:setObjectVisible("score_label_text2",true)
		self:setTextByLanKey("gang_label_text2", "new_str_0444")
		self:setTextByLanKey("gang_label_text3", "guild_high_war_yan_text_0023")
...
function M:updateTitleText()
	self:setObjectVisible("tip_node_text",self.m_model.m_sel_tab_index == 3 or self.m_model.m_sel_tab_index == 4)
	self:setTextByLanKey("tip_node_text","guild_high_war_yan_text_0022")
end
--[[
	创建列表
]]
