local M = class("DrawTaskPanelControl", LikeOO.OOControlBase)
...
function M:getDrawTask(data)
    ...
    params.vsn = self.m_model.m_version
    self.m_model:getNetData("draw_recv_task", params, callback, nil, true)
end
...
function M:getDrawBuy()
    ...
    params.vsn = self.m_model.m_version
    self.m_model:getNetData("draw_buy", params, callback, nil, true)
end
...
function M:getDrawLogin()
    ...
    params.day = self.m_model.m_select_index
    params.vsn = self.m_model.m_version
    self.m_model:getNetData("draw_recv_login", params, callback, nil, true)
end
