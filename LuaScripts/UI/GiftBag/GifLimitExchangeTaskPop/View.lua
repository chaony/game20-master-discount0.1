local M = class("GifLimitExchangeTaskPopView", LikeOO.OOPopBase)

M.m_uiName = "GiftBag/GifLimitExchangeTaskPop"
M.m_size_type = 2

function M:onEnter()
    RedPointUtil:setScrollActiveShopRedPoint()
...
function M:createLoopScroll()
    self.m_gift_tab = {}
    local data = self.m_model:getTaskTab()
    if self.m_scroll_view == nil then
