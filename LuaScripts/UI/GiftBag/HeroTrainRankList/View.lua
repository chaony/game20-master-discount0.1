local M = class("HeroTrainRankListView", LikeOO.OOPopBase)
--排行奖励

M.m_uiName = "GiftBag/HeroTrainRankList"
M.m_size_type = 2
...
function M:updateRankItem(obj, index, data, my_bl)
    ...
    if luaBehaviour then
        ...
        if my_bl == true then
            ...
            local server_name = Language:getTextByKey("new_str_0089").. UserDataManager.server_data:getServerName()
            ...
            LuaBehaviourUtil.setTextByLanKey(luaBehaviour, "server_text", Language:getTextByKey("new_str_0089")..data.user.server)    
