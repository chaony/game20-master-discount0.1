local M = class("SecretRewardGiftPopView", LikeOO.OOPopBase)
...
function M:updateTimItem(index, obj, cell_data)
	...
	if luaBehaviour then
		...
		local sort = cell_data.sort or 1
		...
		if sort == 1 then -- 元宝
			LuaBehaviourUtil.setTextByLanKey(luaBehaviour,"cost_num_text", tostring(cell_data.price))
