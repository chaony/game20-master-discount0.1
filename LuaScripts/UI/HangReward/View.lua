---@class HangRewardView:OOPopBase
local M = class("HangRewardView",LikeOO.OOPopBase)

M.m_uiName = "HangReward/HangReward"
M.m_size_type = 2

local __TAB_BTN_NODE = { 
	{btn_key = "tog_1", lua_name = "UI.HangReward.HongEarningsNode", text_key = "tog_1_text",show_text_lan_id = "handreward_type_1", show_text = "挂机收益" , red_point_img = "battle_red_point_img"}, -- 收益
...
function M:onEnter()
	...
	self:setObjectVisible("Tog_Group", true)
