---@class TokenView:OOPopBase
---@field m_model TokenModel
---@field m_control TokenControl
local M=class("TokenView",LikeOO.OOPopBase)

M.m_iphoneXAdapter = true

M.m_uiName = "Token/TokenPop"
...
function M:onEnter()
    ...
    self:setTextByLanKey("close_title_text", "token_text_001")
...
function M:getSecondaryTagCfg(data)
    for k, v in pairs(_TOKEN_TAB) do
