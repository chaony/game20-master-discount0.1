---@class AchievementRankListView:OOPopBase
---@field m_model AchievementRankListModel
local M = class("AchievementRankListView",LikeOO.OOPopBase)
...
function M:onEnter()
	...
	self:setTextByLanKey("score_label_text", "achievement_text7")
	...
	self:setTextByLanKey("lv_label_text", "achievement_jd_tex")
...
function M:updateItemInfo(obj, data, id)
    ...
    UIUtil.setTextByLanKey(transform, "level_text", "achievement_text6", numStr, data.score)
