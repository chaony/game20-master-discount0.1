local M = class("EvilShadowDateModel", LikeOO.OODataBase)
...
function M:getZhuanjiDetailTitle()
	local story_tab = ConfigManager:getCfgByName("evil_shadow_story") or {}
...
function M:updateRewardBoxData()
	local show_data = {}
	local evil_shadow_reward = ConfigManager:getCfgByName("evil_shadow_reward")[self.m_version] or {}
