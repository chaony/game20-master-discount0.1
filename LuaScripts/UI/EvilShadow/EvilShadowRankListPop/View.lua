local M = class("EvilShadowRankListPopView",LikeOO.OOPopBase)

M.m_uiName = "EvilShadow/EvilShadowRankListPop"
M.m_size_type = 2
...
function M:updateRewardItem(obj, index, data)
    ...
    if luaBehaviour then
        ...
        GameUtil:createRewards(reward_node.transform, data.daily_rewards, true, true)
    end    
end
