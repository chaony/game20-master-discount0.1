---@class CanwuEarningsNode:OOUIbase
---@field m_model CanwuModel
--- 参悟收益
local M = class("CanwuEarningsNode", LikeOO.OOUIbase)

M.m_uiName = "HangReward/CanwuEarningsNode"
M.m_iphoneXAdapter = true

function M:onEnter()
    self:setTextByLanKey("time_desc_text", "canwu_str_0001")
...
function M:refreshUI()
    ...
    local isle_coin_data = RewardUtil:getProcessRewardData({RewardUtil.REWARD_TYPE_KEYS.HERO_ISLE_COIN})

    self:setImg(coin_data.icon_name, coin_data.atlas_name, "coin")
    self:setImg(isle_coin_data.icon_name, isle_coin_data.atlas_name, "isle_coin")

    self:setTextByLanKey("coin_num","new_str_0704", self.m_model:getIdleCoin())
    self:setTextByLanKey("isle_coin_num", "new_str_0704",self.m_model:getIdleHERO_ISLE_COIN())
	...
	self:setTextByLanKey("title_text", "canwu_str_0002")
