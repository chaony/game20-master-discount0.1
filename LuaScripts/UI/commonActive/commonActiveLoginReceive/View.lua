local M = class("commonActiveLoginReceiveView",LikeOO.OOPopBase)

M.m_uiName = "commonActive/commonActiveLoginReceive"
M.m_size_type = 2
...
function M:onEnter()
	...
	--设置spine
	local spine_name = self.m_model:getHeroSpine().hero_spine
