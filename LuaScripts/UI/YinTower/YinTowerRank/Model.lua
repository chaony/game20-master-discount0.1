local M = class("YinTowerRankModel", LikeOO.OODataBase)
...
function M:onCreate()
	...
	self:getData("dark_tower_rank_info", {vsn = self.m_vsn, start = 1, stop = 50})
end
...
function M:getRewardData()
	...
	local rank_cfg = ConfigManager:getCfgByName("yinyang_tower_ranking")
