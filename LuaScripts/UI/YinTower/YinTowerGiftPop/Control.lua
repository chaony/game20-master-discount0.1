local M = class("YinTowerGiftPopControl",LikeOO.OOControlBase)
...
function M:onHandle(msg , data)
    if msg == 99999 then
        ...
        self:updateMsg("refreshRedPoint" ,nil ,"YinTower")
        self:closeView()
    ...
    elseif msg == "gift_btn" then
        ...
        RedPointUtil:saveLocalRedPointFreshTime("dark_tower_reward_once")
...
function M:questFreeReward(data)
    ...
    self.m_model:getNetData("dark_tower_receive_free_gifts", params, netCallback)
end
