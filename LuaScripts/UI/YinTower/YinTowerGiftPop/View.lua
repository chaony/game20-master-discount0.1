local M = class("YinTowerGiftPopView",LikeOO.OOPopBase)
--成长礼包
M.m_uiName = "YinTower/YinTowerGiftPop"
M.m_size_type = 1
...
function M:update_Gift(index, cell_obj, cell_data)
	...
	if luaBehaviour then
		...
		LuaBehaviourUtil.setTextByLanKey(luaBehaviour, "lock_star_text","budoServer_text_0015", numStr, tostring(cell_data.num))
