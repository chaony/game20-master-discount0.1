local M = class("WishRaceHerosPopView",LikeOO.OOPopBase)

M.m_uiName = "Pub/WishRaceHerosPop"
M.m_size_type = 2
	...
	if self.m_loop_scroll_view == nil then
		...
		local params = {
			...
			click_func = function(index, cell_object, cell_data, click_object, click_name)
				...
				local finish = self.m_model:isFinishHero(cell_data)
				if finish == 1 then
...
function M:updateHeroContent(obj, heroOid)
	...
	self:setTextByLanKey("common_title_text", "Pub_str_0006")
