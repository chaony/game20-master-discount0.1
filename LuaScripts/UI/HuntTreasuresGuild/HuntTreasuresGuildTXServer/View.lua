local M = class("HuntTreasuresGuildTXServerView",LikeOO.OOPopBase)

M.m_uiName = "HuntTreasuresGuild/HuntTreasuresGuildTXServer"  -- prefab name
M.m_size_type = 1
...
function M:updateActivityTimer()
    ...
    if end_ts >= 0 then
        ...
        self:setTextByLanKey("text_time", text)
    else
        self:setTextByLanKey("text_time", "new_str_0558")
    end
end
