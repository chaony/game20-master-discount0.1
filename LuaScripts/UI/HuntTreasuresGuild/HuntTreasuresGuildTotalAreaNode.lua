local M = class("HuntTreasuresGuildTotalAreaNode",LikeOO.OOUIbase)

M.m_uiName = "HuntTreasuresGuild/HuntTreasuresGuildTotalAreaNode"
local __max_mines_num = 5 --一页里的最大矿点数量
...
function M:initMineNode()
    for i = 1, __max_mines_num do
        ...
        local prefab = GameUtil:createPrefab("HuntTreasuresGuild/HuntTreasuresGuildMineNode",mine_node.transform)
