local M = class("HuntTreasuresGuildRankView",LikeOO.OOPopBase)

M.m_uiName = "HuntTreasuresGuild/HuntTreasuresGuildRankPop"
M.m_size_type = 2
...
function M:onEnter()
	...
	self:setTextByLanKey("progress_label_text", "hunt_treasure_guild_str_009", self.m_model:getGuildExploreRewardLimit())
	self:setTextByLanKey("top_tips_text", "tid#mining_dec_08")
	self:setTextByLanKey("explore_label_text", "total_world_rank_title_7")
	self:refreshUI()
end
