---@class HalfAnniversaryGiftBagView: OOPopBase
---@field m_model HalfAnniversaryGiftBagModel
local M = class("HalfAnniversaryGiftBagView", LikeOO.OOPopBase)
...
function M:onEnter()
    ...
    local activityXlsxData = BtnOpenUtil:getBtnCfg(self.m_model.m_open_id)
    if activityXlsxData then
        self:setTextByLanKey("close_title_text", "half_year_text_0005" )
    end
