local M = class("HalfAnniversarySecretView", LikeOO.OOPopBase)
...
function M:updateCostUI()
	...
	local hero_img = self:findImage("hero_img")
	GameUtil:updateResourcesImg(hero_img, "Texture/" .. scroll_cfg.photo)
	hero_img:SetNativeSize()
end
