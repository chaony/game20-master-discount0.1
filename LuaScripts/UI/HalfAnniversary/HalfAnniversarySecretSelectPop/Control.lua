...
function M:setBigPrize()
    local function receivetCallback(response)
        ...
        self:updateMsg("updateBigPrize", response.big_gift_id, "HalfAnniversary.HalfAnniversarySecret")
        self:updateMsg(99999)
    end
    local params = {gift_id = self.m_model.m_select_big_id, vsn = self.m_model.m_version}
    self.m_model:getNetData("active_monster_set_big_prize", params, receivetCallback)
end
