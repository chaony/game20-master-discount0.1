---@class HalfAnniversarySignView: OOPopBase
---@field m_model HalfAnniversarySignModel
local M = class("HalfAnniversarySignView", LikeOO.OOPopBase)
...
function M:onEnter()
    ...
    self:setTextByLanKey("close_title_text", Language:getTextByKey("half_year_text_0002"))
    self:refreshUI()
    self:setSpine()
end
...
function M:setSpine()
    ...
    GameUtil:updateSpineLoadSet(play_img, "RoleSpine/hero_050402_SkeletonData", "idle", 0, true)
