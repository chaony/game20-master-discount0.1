---@class UpdateView:OOPopBase
---@field m_control UpdateControl
...
function M:downloadRes(fileName, url, md5, file_size)
	...
	if self.m_Hotupdate.DownLoadFileNew ~= nil then
		self.m_Hotupdate:DownLoadFileNew(fileName, url, md5, file_size, httpStatus, slider)
	else
