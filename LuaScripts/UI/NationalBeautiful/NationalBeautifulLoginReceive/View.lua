local M = class("NationalBeautifulLoginReceiveView",LikeOO.OOPopBase)

M.m_uiName = "NationalBeautiful/NationalBeautifulLoginReceive"
M.m_size_type = 2
...
function M:onEnter()
	...
	if active_data then
		...
		local heroID = active_data.entrance_img ~= nil  and active_data.entrance_img or "721"
...
function M:refreshReward()
	...
	for i=1,box_num do
		...
		--红点
		LuaBehaviourUtil.setObjectVisible(luaBehaviour, "red_point_img", data.status_reward_1 == 1)
		--奖励置灰
