local M = class("NationalBeautifulMainModel", LikeOO.OODataBase)
...
function M:onEnter()
	self.m_items = {
		{open_id = 409, btn_name = "item_1_btn", prefab_folder = "NationalBeautiful",prefab_name = "NationalBeautifulLoginReceive",show_start_open = false}, 	--红袖添香
		{open_id = 410, btn_name = "item_2_btn", prefab_folder = "NationalBeautiful",prefab_name = "NationalBeautifulXkz",show_start_open = false}, 	--巾帼红颜
		{open_id = 411, btn_name = "item_3_btn", prefab_folder = "Chivalry",prefab_name = "ChivalryBattle",show_start_open = false}, 	--郿坞试炼
		{open_id = 412, btn_name = "item_4_btn", prefab_folder = "NationalBeautiful",prefab_name = "NationalBeautifulHeroesList",show_start_open = true}, 	--天香群英榜
		{open_id = 413, btn_name = "item_5_btn", prefab_folder = "commonActive",prefab_name = "commonGiftTwo",show_start_open = false}, 	--天香献礼
		{open_id = 346, btn_name = "item_6_btn", prefab_folder = "commonActive",prefab_name = "commonLuckDraw",show_start_open = false,is_recharge = true}, 	--花落谁家
	}
