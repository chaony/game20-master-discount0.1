local M = class("DragonswordBattleRankPopView",LikeOO.OOPopBase)

M.m_uiName = "Dragonsword/DragonswordBattleRank"
M.m_size_type = 2
...
function M:onEnter()
	...
	self:setTextByLanKey("common_title_text", "moon_shadow_str_008")
	self:setTextByLanKey("score_label_text", "moon_shadow_str_009")
	self:refreshUI()
end
