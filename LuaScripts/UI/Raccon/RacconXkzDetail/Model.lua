local M = class("RacconXkzDetailModel", LikeOO.OODataBase)
...
function M:onEnter()
	...
	self.m_raccon_biography_hero = ConfigManager:getCfgByName("raccon_biography_hero") or {}
	self.m_raccon_biography_stage = ConfigManager:getCfgByName("raccon_biography_stage") or {}
