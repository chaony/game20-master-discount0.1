...
local M = class("QiXiLoveView", LikeOO.OOPopBase)

M.m_uiName = "QiXi/QiXiLove"
M.m_size_type = 1
...
function M:bindUI()
    self:setTextByLanKey("text_title1", "qi_xi_109")
    self:setTextByLanKey("text_title2", "qi_xi_110")
    self:setTextByLanKey("rank_reward_btn_text", "flower_text_0053")
    self:setTextByLanKey("text_myTitle", "flower_text_0068")
    self:setTextByLanKey("text_myTeamTitle", "flower_text_0068")
    self:setTextByLanKey("text_myTab", "qi_xi_109")
    self:setTextByLanKey("text_myTeamTab", "qi_xi_110")
end
