local M = class("ActiveCurrentDateView",LikeOO.OOPopBase)

M.m_uiName = "ActiveCurrent/ActiveCurrentDate"
M.m_size_type = 1
...
function M:onEnter()
	...
	self:setTextByLanKey("down_text",Language:getTextByKey("active_current_str_0003",score))
...
function M:updateZhuanjiLoopScrollCell(index, cell_object, cell_data)
	...
	local bg_img_name = "a_tbh_zhiyue_zhuanji01"
	...
	elseif cell_data.status == 0 then	--未开启
		bg_img_name = "a_tbh_zhiyue_zhuanji02"
