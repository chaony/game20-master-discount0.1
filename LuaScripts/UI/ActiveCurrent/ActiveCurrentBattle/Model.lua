local M = class("ActiveCurrentBattleModel", LikeOO.OODataBase)

function M:onCreate()
	M.super.onCreate(self)
	self:getData("hero_event_train_index",{version = self.m_params.version or 1})
end
...
function M:onEnter()
	...
	self.m_max_damage = self.m_data.max_damage --最大伤害
...
function M:getRankingData()
	self.ranking_reward = {}
	local dragon_ranking = ConfigManager:getCfgByName("hero_event_ranking")
