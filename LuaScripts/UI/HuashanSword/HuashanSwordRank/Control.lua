local M = class("HuashanSwordRankControl",LikeOO.OOControlBase)
...
function M:onHandle(msg , data)
    ...
    elseif msg == "item_click" then
        ...
        self:openView("Pops.PlayerInfo", {uid = item_data.user.uid, look_model = 2})
    elseif msg == "explain_btn" then
        self:openView("HuashanSword.HuashanSwordScoreExplain")
    end
end
