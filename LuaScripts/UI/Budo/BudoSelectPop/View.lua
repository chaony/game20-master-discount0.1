local M = class("BudoSelectPopView",LikeOO.OOPopBase)

M.m_uiName = "Budo/BudoSelectPop"
M.m_size_type = 1
...
function M:onEnter()
	...
	self:setTextByLanKey("receive_text","new_str_0056")
	self:refreshUI()
...
function M:refreshUI()
	...
	for i = 1, 4 do
		...
		self:setObjectVisible("item_lock_" .. i, open_bl == false)
