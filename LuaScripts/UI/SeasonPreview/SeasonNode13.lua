local M = class("SeasonNode13",LikeOO.OOUIbase)

M.m_uiName = "SeasonPreview/season_13"
...
local jump_icon_tab = {"a_dlsj_bsj_dfbz", "a_dlsj_bsj_jstx"}
function M:updateFuncDesNode(func_name)
    ...
    if self.m_model.m_is_show_func_node then
        ...
        local img = jump_icon_tab[btn_id - 23] or ""
...
function M:setSpine()
    for i = 1, 1 do
        ...
        local spine_name = "Axian_SkeletonData"
