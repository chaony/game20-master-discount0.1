local M = class("SeasonNode6",LikeOO.OOUIbase)

M.m_uiName = "SeasonPreview/season_6"
...
local jump_icon_tab = {"a_dlsj_tmxx", "a_dlsj_xxsh"}
function M:updateFuncDesNode(func_name)
    ...
    if self.m_model.m_is_show_func_node then
        ...
        local img = jump_icon_tab[btn_id - 19] or ""
