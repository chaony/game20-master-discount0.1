...
M.m_uiName = "WorldMapNew/WorldMapTaskReward/WorldMapTaskRewardPop"
M.m_size_type = 2
...
local __TAB_BTN_NODE = { 
	{btn_key = "tog_1", lua_name = "UI.WorldMapNew.WorldMapTaskReward.TaskRewardBranchNode", text_key = "tog_1_text", show_text = "事件: " , red_point_img = "battle_red_point_img"}, -- 事件
	{btn_key = "tog_2", lua_name = "UI.WorldMapNew.WorldMapTaskReward.TaskRewardAreaNode", text_key = "tog_2_text", show_text = "区域: " , red_point_img = "battle_red_point_img"}, -- 区域
	{btn_key = "tog_3", lua_name = "UI.WorldMapNew.WorldMapTaskReward.TaskRewardMissionNode", text_key = "tog_3_text", show_text = "委托: " , red_point_img = "battle_red_point_img"}, -- 委托
}
...
function M:onEnter()
	...
	for k,v in pairs(__TAB_BTN_NODE) do
		...
		if k == 1 then
			...
			self:setTextByLanKey(v.text_key, v.show_text..num)
	...
	self:setObjectVisible("click_btn", false)
	
	local regional_map_cfg = ConfigManager:getCfgByName("new_regional_map")
