...
M.m_uiName = "WorldMapNew/WorldMapTaskReward/TaskRewardAreaNode"
...
function M:onEnter()
    ...
    if LikeOO.NewMap2DControl.curMap2D ~= nil then
        self.cur_map_id = LikeOO.NewMap2DControl.curMap2D.map_id
    end
...
function M:refreshUI()
    ...
    local route_obj = ResourceUtil:LoadUIGameObject("NewMap/MapRoute/Route"..self.mother_map_id, Vector3.zero, scroll.viewport.gameObject)
