local M = class("MazeStageHeroSelectView",LikeOO.OOPopBase)

M.m_uiName = "MazeStage/MazeStageHeroSelect"
M.m_size_type = 2
	...
	if self.m_loop_scroll_view == nil then
		...
		local params = {
			...
			update_cell = function(index, cell_object, cell_data)
				...
				LuaBehaviourUtil.setTextByLanKey(luaBehaviour, "combat_text", "new_str_0490")
