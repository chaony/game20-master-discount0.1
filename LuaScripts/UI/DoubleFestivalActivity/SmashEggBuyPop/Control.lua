local M = class("SmashEggBuyPopControl",LikeOO.OOControlBase)
...
function M:onHandle(msg , data)
    if msg == 99999 then    -- 返回
        self:updateMsg("refresh_data",{openId = self.m_model.m_openId},"DoubleFestivalActivity.DoubleFestivalMain")
