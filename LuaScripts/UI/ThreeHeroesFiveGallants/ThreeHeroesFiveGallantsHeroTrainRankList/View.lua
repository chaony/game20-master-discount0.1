local M = class("ThreeHeroesFiveGallantsHeroTrainRankListView", LikeOO.OOPopBase)
--排行奖励

M.m_uiName = "ThreeHeroesFiveGallants/ThreeHeroesFiveGallantsHeroTrainRankList"
M.m_size_type = 2
