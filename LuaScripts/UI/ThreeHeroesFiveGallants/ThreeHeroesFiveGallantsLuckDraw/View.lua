local M = class("ThreeHeroesFiveGallantsLuckDrawView",LikeOO.OOPopBase)

M.m_uiName = "ThreeHeroesFiveGallants/ThreeHeroesFiveGallantsLuckDraw"
M.m_size_type = 1
...
function M:onEnter()
	...
	--end
	self:setTextByLanKey("close_title_text", "raccon_text_0007") --抽奖
...
function M:refreshUI()
	...
	if todayIsCharge == 1 and not isRewardClear then --可抽奖
...
function M:setHeroInfo()
	local hero_cfg = UserDataManager.hero_data:getHeroConfigByCid(tonumber(self.m_model.m_hero_cfg_id))
