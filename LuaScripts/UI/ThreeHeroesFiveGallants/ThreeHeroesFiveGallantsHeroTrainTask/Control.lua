local M = class("ThreeHeroesFiveGallantsHeroTrainTaskControl", LikeOO.OOControlBase)
...
function M:getReward(data)
    local function callback(response)
        if response.update then
            self:updateMsg("update_data", self.m_model.m_data, "ThreeHeroesFiveGallants.ThreeHeroesFiveGallantsBattle")
        ...
        self:updateMsg("update_quest", response, "ThreeHeroesFiveGallants.ThreeHeroesFiveGallantsBattle")
    ...
    self.m_model:getNetData("chivalrous_recv_reward", params, callback)
end
...
function M:getRewardAll()
    ...
    local params = {}
    params.version = self.m_model.version;
    self.m_model:getNetData("chivalrous_recv_reward_all", params, callback)
end
