--- 剧情对话
local M = class("ThreeHeroesFiveGallantsStoreDramaView", LikeOO.OOPopBase)

M.m_uiName = "ThreeHeroesFiveGallants/ThreeHeroesFiveGallantsStoreDrama"
M.m_size_type = 2
...
function M:resetViewBeforeWord()
    ...
    self:setColorA(self.m_blackScreenbg, 0)
