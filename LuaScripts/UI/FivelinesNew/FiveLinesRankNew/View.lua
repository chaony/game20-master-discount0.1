local M = class("FiveLinesRankNewView",LikeOO.OOPopBase)

M.m_uiName = "FivelinesNew/FiveLinesRankNew"
M.m_size_type = 2
M.m_iphoneXAdapter = true

local __TAB_BTN_NODE = { 
	--    show_sidebar(是否显示侧边栏)
	{btn_key = "tog_1", lua_name = "UI.FivelinesNew.FiveLinesRankNew.RankingNodeNew", text_name = "tog_1_text", text_key = "排名"}, -- 排名
	{btn_key = "tog_2", lua_name = "UI.FivelinesNew.FiveLinesRankNew.DetailsNodeNew", text_name = "tog_2_text", text_key = "详情" }, -- 详情
}
