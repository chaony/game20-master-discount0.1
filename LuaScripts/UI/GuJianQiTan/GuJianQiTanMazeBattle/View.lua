local M = class("GuJianQiTanMazeBattleView",LikeOO.OOPopBase)

M.m_uiName = "GuJianQiTan/GuJianQiTanMazeBattle"
M.m_size_type = 2

function M:onEnter()
	local cell_type = self.m_model.m_cell_data.type
	local maze_cell_type = ConfigManager:getCfgByName("sword_akuma_element")
	...
	if cell_type == 1 then--小怪
		-- self:setTextByLanKey("maze_stage_detail_title_text", "new_str_0184")
		-- self:setTextByLanKey("tips_text", "new_str_0187")
		local maze_stage_detail_title_text1 = self:setTextByLanKey("common_title_text", maze_cell_type_item.name or "???")
		maze_stage_detail_title_text1.gameObject:SetActive(true)
	elseif cell_type == 2 then--精英
		-- self:setTextByLanKey("maze_stage_detail_title_text", "new_str_0185")
		-- self:setTextByLanKey("tips_text", "new_str_0188")
		local maze_stage_detail_title_text2 = self:setTextByLanKey("common_title_text", maze_cell_type_item.name or "???")
		maze_stage_detail_title_text2.gameObject:SetActive(true)
	elseif cell_type == 3 then--boss
		-- self:setTextByLanKey("maze_stage_detail_title_text", "new_str_0186")
		-- self:setTextByLanKey("tips_text", "new_str_0189")
		local maze_stage_detail_title_text3 = self:setTextByLanKey("common_title_text", maze_cell_type_item.name or "???")
		maze_stage_detail_title_text3.gameObject:SetActive(true)
	end
	...
	self:setTextByLanKey("speed_btttle_btn_text", "new_str_0811")
	--end
	if self.m_model:canQuickBattle() and false then
