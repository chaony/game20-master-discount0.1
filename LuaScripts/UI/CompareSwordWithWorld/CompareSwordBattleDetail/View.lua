local M = class("CompareSwordBattleDetailDetailView",LikeOO.OOPopBase)

M.m_uiName = "CompareSwordWithWorld/GameOfHeavenAndEarth/CompareSwordBattleDetail"	--CompareSwordWithWorld.CompareSwordBattleDetail
M.m_size_type = 2
