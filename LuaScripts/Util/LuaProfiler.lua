...
function LuaProfiler:SaveProfile()
	...
	if not CS.System.IO.Directory.Exists(CS.UnityEngine.Application.persistentDataPath.."/profilers/") then
		CS.System.IO.Directory.CreateDirectory(CS.UnityEngine.Application.persistentDataPath.."/profilers/")
	end
	local logger = CS.LogFileRecorder(CS.UnityEngine.Application.persistentDataPath.."/profilers/"..self.name..".csv")
...
function LuaProfiler.SaveToFile(txtContent,fileName)
	local logger = CS.LogFileRecorder(CS.UnityEngine.Application.persistentDataPath.."/"..fileName..".txt")
