...
--天机楼场景引导
---@class TianJiLouSceneGuide_View @
local M = class("TianJiLouSceneGuide_View")
...
function M:easeValue(startP, endP, t )
    return Mathf.Lerp(startP, endP, t)
end


function M:ease( startP, endP, t)
    local x = Mathf.Lerp(startP.x, endP.x, t)
    local y = Mathf.Lerp(startP.y, endP.y, t)
    local z = Mathf.Lerp(startP.z, endP.z, t)
