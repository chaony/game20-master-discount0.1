...
--时光之巅战斗场景
---@class ShiGuangFightScene : FightScene @
---@field super FightScene @FightScene
local M = class("ShiGuangFightScene",Battle.FightScene)
...
function M:getCurSceneObjName()
    return "shiguangzhidian_data_fight";
end
