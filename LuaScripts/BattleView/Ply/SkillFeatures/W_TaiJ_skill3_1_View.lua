--太极身周围会环绕一个阴阳球，每当太极释放普攻时，若身边存在阴阳球，
--则太极会将阴阳球扔至随机敌方脚下，对小范围内的敌人造成180%攻击力
--的内功伤害，扔出的阴阳球会在战场上停留3秒，之后再返回太极身边
---@class W_TaiJ_skill3_1_View : SkillFeatures_View @
---@field super SkillFeatures_View @SkillFeatures_View
local M = class("W_TaiJ_skill3_1_View", SkillFeatures_View)
...
--    self:addEventListener_Local(Battle.SkillEventType.MV_W_TaiJ_skill3_1_Model_ShowEffect, {self,self.MV_W_TaiJ_skill3_1_Model_ShowEffect})
--end
--
--
----隐藏和显示特效
