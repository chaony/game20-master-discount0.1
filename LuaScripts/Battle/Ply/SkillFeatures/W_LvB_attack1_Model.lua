...
---@class W_LvB_attack1_Model : SkillFeatures_Model @
---@field super SkillFeatures_Model @SkillFeatures_Model
local M = class("W_LvB_attack1_Model", SkillFeatures_Model)
...
function M:canUse()
    ...
    if table.nums(W_LvB_skill3) > 0 and self.skill3.level >= 4 then
        return false
    end
    return true
end
