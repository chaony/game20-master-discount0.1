...
--戰鬥開始時，蝴蝶君先將與自己位置先對的敵人禁錮，隨後瞬移至其身後，對其造成300%攻擊力的傷害並使其眩暈2秒
---@class W_HuDJ_skill1_1_Model : SkillFeatures_Model @
---@field super SkillFeatures_Model @SkillFeatures_Model
local M = class("W_HuDJ_skill1_1_Model", SkillFeatures_Model)
