--等级2:敌方身上每有一种"七伤"诅咒,造成的伤害增加10%,最多增加30%
local W_WanH_skill3_1_Model = require("Battle.Ply.SkillFeatures.W_WanH_skill3_1_Model")

---@class W_WanH_skill3_2_Model : W_WanH_skill3_1_Model @
---@field super W_WanH_skill3_1_Model @W_WanH_skill3_1_Model
local M = class("W_WanH_skill3_2_Model", W_WanH_skill3_1_Model)
