---@class G_FuW_skill1_1_Model : SkillFeatures_Model @
---@field super SkillFeatures_Model @SkillFeatures_Model
local M = class("G_FuW_skill1_1_Model", SkillFeatures_Model)
local send_control = require("Battle.Ply.SkillFeaturesData.G_FuW_skill1_1_Data")
...
function M:CreateHp()
    local headUIData = {}
    headUIData.uiName = "G_FuW_skill1";
