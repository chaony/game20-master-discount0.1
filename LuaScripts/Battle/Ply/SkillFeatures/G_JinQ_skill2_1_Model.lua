---@class G_JinQ_skill2_1_Model : SkillFeatures_Model @
---@field super SkillFeatures_Model @SkillFeatures_Model
local M = class("G_JinQ_skill2_1_Model", SkillFeatures_Model)
...
function M:spawn()
    ...
    self:dispatchEvent_Local(Battle.SkillEventType.MV_G_JinQ_skill2_1_Model_CreateFootEffect)
...
function M:showEffect(show)
    local data = {}
    data.show = show;
    self:dispatchEvent_Local(Battle.SkillEventType.MV_G_JinQ_skill2_1_Model_ShowEffect,data)
end
