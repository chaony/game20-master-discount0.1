...
--召唤物 Idle AI基类
---@class AIStateIdle_Summon : AIState @
---@field super AIState @AIState
local M = class("AIStateIdle_Summon",Battle.AIState)
...
function M:enter()
    M.super.enter(self)
    --先将动作切换到站立
    self.player.animator:changeState(self.extra_anim_name or self.anim_name )
