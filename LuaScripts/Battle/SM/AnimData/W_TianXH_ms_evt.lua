          ...
          ["level1"] = 
          {
              ...
              [2] = 
              {
                  ...
                  ["prefabList"] = 
                  {
                      ["0"] = {
                          ["type"] = "injureHit",
                          ["prefab"] = "W_TianXH_Attack_Hit_001",
                          ["parent"] = "Xiong",
                          ["position"] = 
                          {
                              ["x"] = 0,
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["triggerTime"] = 358,
                  ["eventId"] = 1,
                  ["prefab"] = "W_TianXH_Skill3_plus_SF_001",
                  ["autoMirror"] = false,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
                  ["isPutUpInParent"] = false,
              ...
              [2] = 
              {
                  ...
                  ["triggerTime"] = 409,
                  ["eventId"] = 2,
                  ["prefab"] = "W_TianXH_Skill3_plus_SF_002",
                  ["autoMirror"] = false,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
                  ["isPutUpInParent"] = false,
