     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["targetNoRepeat"] = false,
                  ["prefabName"] = "W_TianL_Attack_Hit_001",
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              ...
              [2] = 
              {
                  ...
                  ["targetNoRepeat"] = false,
                  ["prefabName"] = "W_TianL_Skill1_Hit_001",
                  ["hitAudio"] = "skill1_hit",
                  ["is_foot"] = false,
                  ["frontdamagePercent"] = 2048,
                  ["lastdamagePercent"] = 1024,
                  ["angerAirPercent"] = 1024,
                  ["power"] = 0,
                  ["noAttack"] = false,
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              ...
              [2] = 
              {
                  ...
                  ["targetNoRepeat"] = false,
                  ["prefabName"] = "W_TianL_Skill1Plus_Hit_001",
                  ["hitAudio"] = "",
                  ["is_foot"] = false,
                  ["frontdamagePercent"] = 2048,
                  ["lastdamagePercent"] = 1024,
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["targetNoRepeat"] = false,
                  ["prefabName"] = "W_TianL_Skill2_Hit_001",
                  ["hitAudio"] = "skill2_hit",
                  ["is_foot"] = false,
                  ["frontdamagePercent"] = 2048,
                  ["lastdamagePercent"] = 1024,
