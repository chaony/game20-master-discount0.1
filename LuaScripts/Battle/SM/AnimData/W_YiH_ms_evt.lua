     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              ...
              [4] = 
              {
                  ["eventName"] = "PlaySound",
                  ["triggerTime"] = 409,
                  ["soundName"] = "ShortVo_Girl_Attack_L2_2",
                  ["bankName"] = "ShortVo_Girl",
              },
              ...
              [5] = 
              {
                  ["eventName"] = "PlayEffect",
                  ["triggerTime"] = 1228,
                  ["prefab"] = "W_YiHua_Skill3_Buff_001",
                  ["autoMirror"] = false,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "RootPoint",
                  ["isPutUpInParent"] = true,
              ...
              [7] = 
              {
                  ["eventName"] = "PlayEffect",
                  ["triggerTime"] = 2150,
                  ["prefab"] = "W_YiHua_Skill3_Buff_002",
                  ["autoMirror"] = true,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "BR_Weapon02",
                  ["isPutUpInParent"] = true,
