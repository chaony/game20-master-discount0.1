     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              ...
              [5] = 
              {
                  ...
                  ["triggerTime"] = 614,
                  ["eventId"] = 5,
                  ["soundName"] = "W_WuZT_717_skill3_plus_2",
                  ["bankName"] = "W_WuZT_717",
              },
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["triggerTime"] = 409,
                  ["eventId"] = 1,
                  ["prefab"] = "W_WuZT_Skill3Plus_SF_002",
                  ["autoMirror"] = false,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
                  ["isPutUpInParent"] = false,
              ...
              [2] = 
              {
                  ...
                  ["triggerTime"] = 1024,
                  ["eventId"] = 2,
                  ["prefab"] = "W_WuZT_Skill3Plus_SF_001",
                  ["autoMirror"] = false,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
                  ["isPutUpInParent"] = false,
