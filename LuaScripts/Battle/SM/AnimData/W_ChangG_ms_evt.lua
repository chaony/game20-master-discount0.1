     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              ...
              [3] = 
              {
                  ...
                  ["prefab"] = "W_ChangG_Attack_Fly_001",
                  ["speed"] = 20,
                  ["lifeTime"] = 2,
                  ["firePoint"] = 
                  {
                  ...
                  ["prefabList"] = 
                  {
                      ["0"] = {
                          ["type"] = "injureHit",
                          ["prefab"] = "W_ChangG_Attack_Hit_001",
                          ["parent"] = "Xiong",
                          ["position"] = 
                          {
                              ["x"] = 0,
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              ...
              [3] = 
              {
                  ...
                  ["prefab"] = "W_ChangG_Skill1_Fly_001",
                  ["speed"] = 20,
                  ["lifeTime"] = 2,
                  ["firePoint"] = 
                  {
                  ...
                  ["prefabList"] = 
                  {
                      ["0"] = {
                          ["type"] = "injureHit",
                          ["prefab"] = "W_ChangG_Skill1_Hit_001",
                          ["parent"] = "Root",
                          ["position"] = 
                          {
                              ["x"] = 0,
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              ...
              [4] = 
              {
                  ...
                  ["effectId"] = 0,
                  ["bulletAudio"] = "skill1_hit",
                  ["prefab"] = "W_ChangG_Skill2_Fly_001",
                  ["speed"] = 20,
                  ["lifeTime"] = 2,
                  ["firePoint"] = 
                  {
                  ...
                  ["prefabList"] = 
                  {
                      ["0"] = {
                          ["type"] = "injureHit",
                          ["prefab"] = "W_ChangG_Skill2_Hit_001",
                          ["parent"] = "Root",
                          ["position"] = 
                          {
                              ["x"] = 0,
          ...
          ["level1"] = 
          {
              ...
              [5] = 
              {
                  ...
                  ["prefabList"] = 
                  {
                      ["0"] = {
                          ["type"] = "injureHit",
                          ["prefab"] = "W_ChangG_Skill3_Hit_001",
                          ["parent"] = "Xiong",
                          ["position"] = 
                          {
                              ["x"] = 0,
