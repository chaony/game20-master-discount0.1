     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["triggerTime"] = 307,
                  ["eventId"] = 1,
                  ["prefab"] = "W_LiangS2_Attack_SF_001",
                  ["autoMirror"] = false,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
              ...
              [2] = 
              {
                  ...
                  ["prefabList"] = 
                  {
                      ["0"] = {
                          ["type"] = "injureHit",
                          ["prefab"] = "W_LiangS2_Attack_Hit_001",
                          ["parent"] = "Root",
                          ["position"] = 
                          {
                              ["x"] = 0,
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["triggerTime"] = 0,
                  ["eventId"] = 1,
                  ["prefab"] = "W_LiangS2_Skill1_SF_001",
                  ["autoMirror"] = true,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
                  ["isPutUpInParent"] = true,
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["triggerTime"] = 460,
                  ["eventId"] = 1,
                  ["prefab"] = "W_LiangS2_Skill3_SF_001",
                  ["autoMirror"] = false,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
                  ["isPutUpInParent"] = true,
          ...
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["prefabList"] = 
                  {
                      ["0"] = {
                          ["type"] = "injureHit",
                          ["prefab"] = "W_LiangS2_Skill3_Hit_001",
                          ["parent"] = "Xiong",
                          ["position"] = 
                          {
                              ["x"] = 0,
