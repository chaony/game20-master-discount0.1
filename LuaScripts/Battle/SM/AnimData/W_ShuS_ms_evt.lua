     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["eventId"] = 1,
                  ["effectId"] = 0,
                  ["bulletAudio"] = "_skill1_hit",
                  ["prefab"] = "W_ShuS_Skill01_Fly_001",
                  ["speed"] = 28,
                  ["lifeTime"] = 2,
                  ["firePoint"] = 
                  {
     ...
     ["events"] = 
     {
          ["level1"] = 
          {
              [1] = 
              {
                  ...
                  ["triggerTime"] = 512,
                  ["eventId"] = 1,
                  ["prefab"] = "W_ShuS_Skill03_Show_001",
                  ["autoMirror"] = true,
                  ["mirrorPrefab"] = false,
                  ["parent"] = "Root",
