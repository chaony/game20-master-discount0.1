...
--    logError("Unhandled Exception: LuaScriptException: " .. tostring(msg) .. ".lua\n".. debug.traceback())
--    print("----------------------------------------")
--end
--
...
--            if index % 7 < 5 then
--                team1[i] = {cid = testIds[index], lv = 300}
--            end
--        end
--
--        local team2 = {}
...
--            local index = math.random(1,#testIds)
--            if index % 7 < 5 then
--                team2[i] = { cid = testIds[index], lv = 300}
--            end
--        end
--
...
--        }
--
--        local key = convert_params_key(params)
--        if not battle_logs[key] then
--            battle_logs[key] = true
